...
function initPenthouse() {
    ...
    var housingQs = [
        ...
        { q: '당신의 이상적인 창밖 풍경은?', opts: ['화려한 불빛과 활기가 넘치는 화려한 시티 뷰', '계절의 변화가 느껴지는 한적한 자연과 마당 뷰'], scores: [{A:1, B:2}, {C:1, D:2}] },
        { q: '집 안에서 나만의 특별한 공간을 만든다면?', opts: ['일에 집중하고 창의력을 발휘할 수 있는 미니 작업실', '푹신한 쿠션과 은은한 조명이 있는 나만의 아늑한 휴식처'], scores: [{E:2, G:1}, {F:1, H:2}] }
    ];
